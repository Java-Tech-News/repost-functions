...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://moderation-function-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://moderation-function-__________run.app
```

Call the api endpoint:
```
curl https://moderation-function-__________run.app/moderationFunction
```
